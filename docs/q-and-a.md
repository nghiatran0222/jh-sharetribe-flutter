...
| Important 4 — Targets / versions | Flutter 3.47.4 stable, pinned in `.fvmrc` (FVM optional); platforms Android + iOS (`flutter create --platforms=android,ios`; web/desktop not generated) | Version: Decided · Platforms: Assumed | [0013](adr/0013-fvm-pin-no-melos.md) (version) |
